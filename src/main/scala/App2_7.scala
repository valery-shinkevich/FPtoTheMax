...
/*
 * Step 7.
 * we've taken on our program which was hard-coded to IO the IO data type and we've made it polymorphic and NDF
 * which supports the set of capabilities required by our program and it's a very fine-grain set of capabilities
 * */
object App2_7 {
